...
export default new Vuex.Store({
  state: {
    ...
    endpoints: {
      api: "http://istio-ingressgateway-istio-system.Running this command requires a running 'istio' VM, but no VM is running..nip.io/web-api/v1/", // example: "http://192.168.99.100:31380/web-api/v1/"
