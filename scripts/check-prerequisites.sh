...
function checkPrerequisites() {
    ...
    java -version &> /dev/null || MISSING_TOOLS="${MISSING_TOOLS} java"
    mvn -version &> /dev/null || MISSING_TOOLS="${MISSING_TOOLS} mvn"
    node -v &> /dev/null || MISSING_TOOLS="${MISSING_TOOLS} node"
    npm -v &> /dev/null || MISSING_TOOLS="${MISSING_TOOLS} npm"
